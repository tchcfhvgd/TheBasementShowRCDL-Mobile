...
class ClientPrefs {
	...
	public static var fromPlaying:Bool = false;
	public static var framerate:Int = 60;
	public static var mechanicsOn:Bool = true;
	...
	public static var canCheat:Bool = true;
	public static var healthBarAlpha:Float = 1;
	public static var slpashAlpha:Float = 0.6;
	public static var firstTimePlaying:Bool = true;
	...
	public static var hesPissed:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.cheaterOn = cheaterOn;
		FlxG.save.data.mechanicsOn = mechanicsOn;
		...
		FlxG.save.data.hesPissed = false;
		FlxG.save.data.slpashAlpha = slpashAlpha;
		FlxG.save.data.comboOffset = comboOffset;
		FlxG.save.data.achievementsMap = Achievements.achievementsMap;
		FlxG.save.data.henchmenDeath = Achievements.henchmenDeath;
        FlxG.save.data.fromPlaying = fromPlaying;
	...
	public static function loadPrefs() {
        ...
        if (FlxG.save.data.fromPlaying != null) {
			fromPlaying = FlxG.save.data.fromPlaying;
		}
        if (FlxG.save.data.cheaterOn != null) {
			cheaterOn = FlxG.save.data.cheaterOn;
		}
        if (FlxG.save.data.canCheat != null) {
			canCheat = FlxG.save.data.canCheat;
		}
		...
		if (FlxG.save.data.judjmentbool != null) {
		    judjmentbool = FlxG.save.data.judjmentbool;
		}
		if (FlxG.save.data.enablemodchart != null) {
		    enablemodchart = FlxG.save.data.enablemodchart;
		}
		...
		if (FlxG.save.data.slpashAlpha != null) {
			slpashAlpha = FlxG.save.data.slpashAlpha;
		}
