...
function onCreate()
	...
	makeLuaSprite('bgThing', 'SongBG/songBG3', -550 - 0, 425)
    ...
    if count > 15 then
        ...
        addLuaText("songText");
        setTextFont('songText', "VCRREAL.ttf")
    ...
    setTextFont('beforeSongText', "VCRREAL.ttf")
    ...
    if showCredit == true then
        ...
        setTextSize('whoDuntIt', 29);
        setTextFont('whoDuntIt', "VCRREAL.ttf")
