...
function onBeatHit( )
	...
	setProperty('boyfriend.x', getProperty('boyfriend.x') - 850)
...
function onStepHit()
	...
	doTweenAlpha('susser', 'dad', 0.5, 0.5, 'circOut')
	doTweenAlpha('sussy', 'gf', 0.5, 0.5, 'circOut')
	end
	...
	if curStep == 1248 then
		doTweenAlpha('sussy', 'gf', 0.5, 0.5, 'circOut')
		doTweenAlpha('sussed', 'boyfriend', 0.5, 0.5, 'circOut')
		doTweenAlpha('susser', 'dad', 0.5, 0.5, 'circOut')
	end
